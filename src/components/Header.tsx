...
export const Header = () => {
  ...
  return (
    <header
      className={`flex items-center justify-between py-10 border-b border-gray-100`}
    >
      <Link
        href={`/`}
      ...
      >
        ...
        <div>
          <h1
            className={`text-2xl font-black uppercase tracking-wide text-gray-800`}
          >
            React Pizza
          </h1>
      ...
      <Link href="/cart">
        <Button
          className={`gb-[#fe5f1e] hover:bg-[#b53a07] text-white font-white font-bold px-6 py-5 rounded-full flex items-center gap-4 transition-colors group`}
        >
