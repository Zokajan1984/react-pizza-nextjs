...
export default function Home() {
  ...
  const filteredProducts = products.filter((pizza) =>
  ...
  return (
    <div className="pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 py-8 pt-6">
        <Categories activeId={activeCategory} onChange={setActiveCategory} />
        <Sort activeSort={activeSort} onChange={setActiveSort} />
      </div>

      <div className="relative max-w-87.5 mb-8">
        ...
        <Input
          ...
          className="pl-10 rounded-xl border-gray-200 focus:border-[#fe5f1e]"
        />
      </div>
